...
(function() {
  var Menu, client, data, fs, mg, moment, qiniu, xlsx;
  ...
  data = Menu.findById("53908926fc534a1955a3d960").select('name list begin_date end_date').populate('list.songs.song', 'name duration').exec(function(err, result) {
    data = [];
